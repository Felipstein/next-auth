...
export function ButtonClientSide({
  loading = false,
  defaultShadow = true,
  asChild = false,
  className,
  ...
  return (
    <ButtonProvider loading={loading}>
      ...
      <Comp
        className={w(
          "relative w-full flex gap-2 items-center justify-center font-medium text-sm rounded-md px-4 py-2.5",
          {
            ...
            "pointer-events-none opacity-20 bg-zinc-700 text-zinc-300": props.disabled || loading,
...
ButtonClientSide.Icon = ButtonIcon;